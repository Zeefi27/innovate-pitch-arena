      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="glass backdrop-blur-md rounded-2xl p-8 shadow-2xl transition-shadow bg-gradient-to-r from-purple-700/90 to-purple-900/80 border border-purple-600">
              <div className="flex items-start mb-6">
                <div className="bg-purple-600/70 rounded-lg p-4 mr-6 shadow-lg">
            ...
            <div className="glass backdrop-blur-md rounded-2xl p-8 shadow-2xl transition-shadow bg-gradient-to-r from-blue-700/90 to-blue-900/80 border border-blue-600">
              <div className="flex items-start mb-6">
                <div className="bg-blue-600/70 rounded-lg p-4 mr-6 shadow-lg">
            ...
            {/* Presentation Skills */}
            <div className="glass backdrop-blur-md rounded-2xl p-8 shadow-2xl transition-shadow bg-gradient-to-r from-cyan-700/90 to-cyan-900/80 border border-cyan-600">
              <div className="flex items-start mb-6">
                <div className="bg-cyan-600/70 rounded-lg p-4 mr-6 shadow-lg">
            ...
            {/* Technical Depth */}
            <div className="glass backdrop-blur-md rounded-2xl p-8 shadow-2xl transition-shadow bg-gradient-to-r from-indigo-700/90 to-indigo-900/80 border border-indigo-600">
              <div className="flex items-start mb-6">
                <div className="bg-indigo-600/70 rounded-lg p-4 mr-6 shadow-lg">
