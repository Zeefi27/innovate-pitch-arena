    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-6 py-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Ideathon 2.0</h3>
            <p className="text-gray-400 mb-4">
              A platform to foster innovation, creativity, and presentation skills among students.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Timeline</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Prizes</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li className="flex items-start">
                ...
                <span>ideathon@example.com</span>
              </li>
              <li className="flex items-start">
                <svg className="h-6 w-6 mr-2 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-sm text-gray-400 text-center">
          <p>&copy; 2025 Ideathon 2.0. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
