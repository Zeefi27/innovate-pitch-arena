...
export function Prizes() {
  return (
    <div className="py-20 bg-white fade-in">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900 heading-font">Prizes & Recognition</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* First Prize */}
          <div className="bg-gradient-to-br from-amber-50 to-amber-100 glass p-8 shadow-lg border-2 border-amber-200 relative overflow-hidden group">
            ...
            <div className="relative">
              ...
              <h3 className="text-2xl font-bold mb-4 text-gray-900 text-center heading-font">First Prize</h3>
          ...
          {/* Second Prize */}
          <div className="bg-gradient-to-br from-slate-50 to-slate-100 glass p-8 shadow-lg border-2 border-slate-200 relative overflow-hidden group">
            ...
            <div className="relative">
              ...
              <h3 className="text-2xl font-bold mb-4 text-gray-900 text-center heading-font">Second Prize</h3>
              <div className="text-center mb-4">
          ...
          {/* Best Presentation */}
          <div className="bg-gradient-to-br from-rose-50 to-rose-100 glass p-8 shadow-lg border-2 border-rose-200 relative overflow-hidden group">
            ...
            <div className="relative">
              ...
              <h3 className="text-2xl font-bold mb-4 text-gray-900 text-center heading-font">Best Presentation</h3>
              <div className="text-center mb-4">
        ...
        <div className="mt-16 bg-purple-50 glass rounded-xl p-8 shadow-md">
          <h3 className="text-xl font-bold mb-6 text-gray-900 text-center heading-font">Additional Recognition</h3>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white rounded-lg p-5 shadow-sm text-center glass">
